...
Automatically discover ONVIF-compatible EZVIZ cameras on the local network
without knowing their IP addresses beforehand.

Prerequisites:
    pip install onvif-zeep

Note: Some EZVIZ cameras ship with ONVIF disabled by default.
Enable it in the camera settings via the EZVIZ app or web UI.
"""
